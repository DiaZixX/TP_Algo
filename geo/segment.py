...
class Segment:
    ...
    def intersection_with(self, segment):
        ...
        x1 = self.endpoints[0].coordinates[0]
        y1 = self.endpoints[0].coordinates[1]
        x2 = self.endpoints[1].coordinates[0]
        y2 = self.endpoints[1].coordinates[1]

        #Segment endpoints coordinates
        x3 = segment.endpoints[0].coordinates[0]
        y3 = segment.endpoints[0].coordinates[1]
        x4 = segment.endpoints[1].coordinates[0]
        y4 = segment.endpoints[1].coordinates[1]
        ...
        #segment.x = x3 + u(x4 - x3) ; segment.y = y3 + u(x4 - x3)
